...
<main class="container py-4">
    ...
    <div class="offers-container">
        ...
        <div class="general-header">
            ...
            <p class="general-subtitle">Find tutoring services for mathematical topics</p>
        </div>

        <div class="div-search-bar">

            <form action="/tutorials/mathematicsFind" method="get">
                <div class="input-group">
                    <input type="text"
                           class="form-control"
                           name="searchTerm"
                           placeholder="Search for mathematical offers..."
                           value="${searchTerm!}">
        ...
        <div class="offers-list-container">
            <div class="offers-list">
                <#list mathematicsTutorialsAsView as w>
                    <div class="offer-card">
                        ...
                        <#if !mathematicsTutorialsAsView?has_content>
                            <div class="no-off">
